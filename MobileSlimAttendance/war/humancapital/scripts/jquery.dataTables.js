	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sEmptyTable": "No employees have created",
		...
		function _fnDrawHead( oSettings, aoSource, bIncludeHidden )
		{
			...
			for ( i=0, iLen=aoLocal.length ; i<iLen ; i++ )
			{
				...
				for ( j=0, jLen=aoLocal[i].length ; j<jLen ; j++ )
				{
					 ...
					 * insert point. If there is, then there is nothing TODO.
					 */
		...
		function _fnScrollDraw ( o )
		{
			...
			if ( o.oScroll.sY === "" )
			{
				 ...
				 * set the height in order to sort this. Don't want TODO it in any other browsers.
				 */
				if ( ie67 )
				{
		 ...
		 * Returns:  -
		 * Inputs:   object:oSettings - dataTables settings object
		 * Notes:    You would probably want TODO a redraw after calling this function!
		 */
		...
		function _fnCalculateColumnWidths ( oSettings )
		{
			...
			{
				/* Otherwise we are going to have TODO some calculations to get the width of each column.
				 * Construct a 1 row table with the widest node in the data, and any user defined widths,
				 * then insert it into the DOM and allow the browser TODO all the hard work of
		...
		function _fnLoadState ( oSettings, oInit )
		{
			...
			if ( sData !== null && sData !== '' )
			{
				...
				{
					/* Pass back visibiliy settings to the init handler, but TODO not here override
		...
		function _fnSetObjectDataFn( mSource )
		{
			if ( mSource === null )
			{
				/* Nothing TODO when the data source is null */
		...
		return this.each(function()
		{
			...
			for ( i=0, iLen=_aoSettings.length ; i<iLen ; i++ )
			{
				 ...
				 * destroyed by other methods. Anyone using non-id selectors will need TODO this manually
				 */
			...
			if ( typeof oInit != 'undefined' && oInit !== null )
			{
				...
				{
					/* Enable sort classes for server-side processing. Safe TODO it here, since server-side
