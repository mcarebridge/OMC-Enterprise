...
<body>
	<div id="wrapper">
		...
		<div id="contentWrapper">
			<c:if test="${sessionScope.logoFileName != null}">
			<div style="float: left; padding: 10px 10px 10px 5px">
			<!-- 	<img alt="" src="/humancapital/images/custLogo/${sessionScope.logoFileName}" height="75" > -->
				<img alt="" src="${sessionScope.logoFileName}" height="75" >
			</div>
			</c:if>		
			<div>
				<h2
